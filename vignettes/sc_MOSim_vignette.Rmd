...
Supposing we're using the data produced in [the previous section](#Real count matrix uploaded in the package), we will simulate a scRNAseq and a scATACseq count matrix.
